...
enum X86_CODE32 = cast(ubyte[])"\xba\xcd\xab\x00\x00\x8d\x4c\x32\x08\x01\xd8\x81\xc6\x34\x12\x00\x00";
...
enum M680X_CODE = cast(ubyte[])"\x06\x10\x19\x1a\x55\x1e\x01\x23\xe9\x31\x06\x34\x55\xa6\x81\xa7\x89\x7f\xff\xa6\x9d\x10\x00\xa7\x91\xa6\x9f\x10\x00\x11\xac\x99\x10\x00\x39";
enum EVM_CODE = cast(ubyte[])"\x60\x61";
...
enum platforms = [
	...
	Platform(Arch.x86, Mode.bit32, X86_CODE32, "X86 32 (MASM syntax)", Syntax.masm),
	...
	Platform(Arch.tms320c64x, Mode.littleEndian, TMS320C64X_CODE, "TMS320C64x"),
	Platform(Arch.m680x, Mode.m680x_6809, M680X_CODE, "M680X_M6809"),
